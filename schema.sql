...
CREATE TABLE products (
  ...
  -- V39: running stock balance, maintained automatically by the
...
-- ══════════════════════════════════════════════════════════════════
--  V39: Incremental stock balance (products.current_stock)
--
...
-- already has data, use migration_v39_stock_balance.sql, NOT this
