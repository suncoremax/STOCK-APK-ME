-- ══════════════════════════════════════════════════════════════════
--  AXIION স্টক ম্যানেজমেন্ট — Supabase Schema V22
--  Miron Electronics
--
...
CREATE TABLE products (
  ...
  -- case_price: source-of-truth bulk (case/jar/poly) price — §7 reverse
  -- price entry. selling_price / purchase_price stay as the derived
  -- per-piece values every transaction actually calculates against.
