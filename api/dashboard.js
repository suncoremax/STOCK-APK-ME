...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // ══════════════════════════════════════════════════════
    //  APP BOOT DATA — folded in from the old load-all.js
    // ══════════════════════════════════════════════════════
    if (action === 'load-all') {
      ...
      const srsBoot   = (sRes.data || []).map(mapSR);
      ...
      return res.json({ ok: true, products, srs: srsBoot, stockMap: calcStock(allTx) });
    }
