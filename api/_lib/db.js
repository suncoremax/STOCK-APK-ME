...
function mapProduct(r) {
  return {
    ...
    // casePrice: source-of-truth bulk price (AXIION §7 — reverse price entry).
    // Column exists from V23 onward; the reverse-calculation input flow
    // itself is a separate blueprint section and lands in a later update.
